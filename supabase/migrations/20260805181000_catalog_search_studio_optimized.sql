-- Catalog search + studiofoto-pad + optimized-flag

drop function if exists public.admin_catalog_search(
  text, text, text, text, text, text, numeric, numeric, numeric, numeric, text, text, text, integer, integer
);
drop function if exists public.admin_catalog_search(
  text, text, text, text, text, text, numeric, numeric, numeric, numeric, text, text, text, integer, integer, text
);
